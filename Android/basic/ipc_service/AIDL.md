...
如果需要引入 java 层的实体类, 需要有 aidl 生命;  
其中 com/alex/andfun/service/huggles/entity/DownloadMessageEntity.aidl  
对应 com.alex.andfun.service.huggles.entity.DownloadMessageEntity.java;  
```
